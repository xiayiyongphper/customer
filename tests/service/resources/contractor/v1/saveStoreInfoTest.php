...
class  saveStoreInfoTest extends ContractorTest
{

    public function _initData()
    {
        $this->header->setRoute('contractor.saveStoreInfo');
    }

    public function testRequest()
    {
        $this->assertInstanceOf('service\message\contractor\SaveStoreRequest', saveStoreInfo::request());
    }
    ...
    public function testRun()
    {
        ...
        $request->setStoreId($this->customer_id);
